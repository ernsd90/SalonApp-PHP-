...
<div class="dashboard-header" style="margin-bottom: 24px;">
    <div style="display: flex; gap: 16px; align-items: center; margin-bottom: 4px;">
        <a href="expenses.php" style="color: var(--text-muted); font-size: 20px; text-decoration: none;"><i class="ph ph-arrow-left"></i></a>
        <h1 style="font-size: 24px; font-weight: 700; color: var(--text-main); margin: 0;">Expense Categories</h1>
    </div>
    <p style="color: var(--text-muted); font-size: 14px; margin-left: 36px;">Organize your outflows for better financial reporting.</p>
</div>
...
<div class="card-modern" style="background: white; border-radius: var(--border-radius); border: 1px solid var(--border-color); box-shadow: var(--shadow-sm); overflow: hidden; margin-bottom: 30px;">
    ...
    <div style="padding: 20px 24px; border-bottom: 1px solid var(--border-color); display: flex; justify-content: space-between; align-items: center;">
        ...
        <button class="btn-primary" style="width: auto; padding: 10px 16px; margin: 0; font-size: 14px; display: flex; align-items: center; gap: 8px;" onclick="loadModal('expenses_cat_edit.php');">
    ...
    <div style="padding: 24px;">
        <div class="table-responsive">
            <table id="get_expensesCat" class="table-modern" style="width: 100%;">
                <thead>
                    <tr>
        ...
        success: function(res) {
            try {
                ...
                if (obj.error == 1) {
                    ...
                    if ($.fn.DataTable.isDataTable('#get_expensesCat')) $('#get_expensesCat').DataTable().draw(false);
                }
            } catch(e) {
