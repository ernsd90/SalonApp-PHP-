                    ...
                    <div class="card-body">
                        <div class="row clearfix">
                            <div class="col-sm-12  p-0">
                                    ...
                                    <form method="post" action="report_print.php" target="_blank" autocomplete="off">
                                        <div class="row clearfix mb-3">
                                            <div class="col-sm-12">
                                                ...
                                                <p>
                                                    <input class="pkg_service" type="checkbox" id="pkg_service" checked  name="pkg_service" value="1" />
                                                    <span id="date-label-to" class="date-label">  Include Pakage service</span>

                                                    <input class="membership_include" type="checkbox" id="membership_include" checked  name="membership_include" value="1" />
                                                    <span id="date-label-to" class="date-label">  Include Membership Sale</span>
                                                </p>
                                            </div>
                                        </div>
                                ...
                                <?php } ?>
                                <table id="get_servicerecord" class="table table-striped table-bordered CommonModelClick">
                                </table>
