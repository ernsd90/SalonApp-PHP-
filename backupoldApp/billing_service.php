								...
								<table class="table table-striped" id="item_table">
									...
									<tbody>
										...
										<tr <?php echo $style; ?> class="item tr_clone<?php echo $i; ?>">
											...
											<td>
												<div class="">
												<input name="service_gst[]" type="hidden"  class="service_gst form-control" id="service_gst" placeholder="GST(%)" value="<?php echo $tax_value ?>">
												<span class="service_gst_txt"><?php echo $tax_value ?>%</span>
												</div>
											</td>
                                            <?php } ?>
											<td class="text-right">
