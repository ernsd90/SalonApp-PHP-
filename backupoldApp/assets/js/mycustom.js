$(document).ready(function () {
    ...
    var get_vendor = $('#get_vendor').DataTable({
        "processing": true,
        "serverSide": true,
        scrollX: true,
        responsive: true,
    ...
    var get_appointment = $('#get_appointment').DataTable({
        "processing": true,
        "serverSide": true,
        scrollX: true,
        responsive: true,
    ...
    var get_customer_details = $('#get_customer_details').DataTable({
        "processing": true,
        "serverSide": true,
        scrollX: true,
        responsive: true,
    ...
    var get_service = $('#get_service').DataTable({
        ...
        "columns": [
            { "title": "id", "data": "service_id" },
            { "title": "Service Name", "data": "service_name" },
            { "title": "Price", "data": "service_price" },
            //{ "title": "Service Time","data": "service_time" },
            { "title": "Category", "data": "service_catid" },
            { "title": "Status", "data": "service_status" },
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                if (obj.error == 1) {
                    ...
                    get_inventory.draw();
                    get_package.draw();
                    if (typeof get_salon !== 'undefined') { get_salon.draw(); }
                    $("#modalButtonCommon").modal('hide');
