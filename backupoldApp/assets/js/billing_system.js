...
$(document).ready(function () {
    ...
    var todayFormatted = ('0' + today.getDate()).slice(-2) + '-' + ('0' + (today.getMonth() + 1)).slice(-2) + '-' + today.getFullYear();
    var yesterdayFormatted = ('0' + yesterday.getDate()).slice(-2) + '-' + ('0' + (yesterday.getMonth() + 1)).slice(-2) + '-' + yesterday.getFullYear();
    ...
    $('#invoice_date').datepicker({
        ...
        beforeShowDay: function (date) {
            ...
            var currentFormatted = ('0' + date.getDate()).slice(-2) + '-' + ('0' + (date.getMonth() + 1)).slice(-2) + '-' + date.getFullYear();
            var todayFormatted = ('0' + today.getDate()).slice(-2) + '-' + ('0' + (today.getMonth() + 1)).slice(-2) + '-' + today.getFullYear();
            var yesterdayFormatted = ('0' + yesterday.getDate()).slice(-2) + '-' + ('0' + (yesterday.getMonth() + 1)).slice(-2) + '-' + yesterday.getFullYear();

            // Allow only today and tomorrow
            if (currentFormatted === todayFormatted || currentFormatted === yesterdayFormatted) {
        ...
        // Only allow today and tomorrow to be selected. If not, reset to today's date.
        var selectedDateFormatted = ('0' + e.date.getDate()).slice(-2) + '-' + ('0' + (e.date.getMonth() + 1)).slice(-2) + '-' + e.date.getFullYear();
        if (selectedDateFormatted !== todayFormatted && selectedDateFormatted !== yesterdayFormatted) {
            // Reset to today's date if the selected date is invalid
            toastr.error("Please select either today or yesterday.", 'Billing Error');
            $('#invoice_date').datepicker('update', today);
        }
    });
});
