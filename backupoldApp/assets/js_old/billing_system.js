...
$(document).ready(function() {
    ...
    $('form#billingform').submit(function() {
        ...
        if (discount_mode == 1) {
            if(discount > 79) {
                toastr.error("Maximum Discount will be 79%", 'Billing Error');
                return false;
            }
        }else{
            if(discount > 5000) {
                toastr.error("Maximum Discount will be Rs 5000 ", 'Billing Error');
                return false;
            }
        }
        var error = '';
    ...
    $('form#productform').submit(function() {
        ...
        $('tr.item').each(function() {
            ...
            if (product_id == 0) {
                ...
                var product_mrp = ($(this).find(".product_mrp").val());
                if (product_staff == 0 || product_staff == undefined) {
                    staff++;
                }
                if (product_mrp > 0) {} else {
                    price++;
                }
