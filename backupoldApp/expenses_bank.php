							...
							<div class="row clearfix">
								<div class="col-sm-12  p-0">
									<div class="row clearfix mb-3">
										<div class="col-sm-6  ">
											<h4 class="card-title">Bank Expenses</h4>
										</div>
										<div class="col-sm-6  ">
											<div class="clearfix">
												<button type="button" style="float:right" class="btn-sm  btn btn-success modalButtonCommon" data-toggle="modal" data-href="expenses_edit.php?payment_mode=cc"><i class="fa fa-plus-circle"></i> Add New Expenses</button>
											</div>
										</div>
									</div>
                                    ...
                                    <div class="table-responsives">
                                        <input  type="hidden" value="cc"  id="expence_type" />
