...
if(is_numeric($salon_id)){
    ...
    $data = select_array("SELECT product_name,(sum(qty)) as ttl_qty,product_type FROM `hr_bill_product` where salon_id='".$salon_id."'  GROUP by product_name order by product_type,product_name asc");
